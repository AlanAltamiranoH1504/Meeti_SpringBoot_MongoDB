    ...
    return (
        <div className="flex flex-col md:flex-row md:items-center justify-between my-10 space-y-2 md:space-y-0 md:space-x-0 border-b-2 border-neutral-400 pb-5">
            ...
            <div className="flex flex-col md:flex-row gap-4">
                <Link to="" className="border-2 border-orange-600 py-4 px-24 rounded-lg shadow-md bg-orange-500 text-white font-semibold font-fjalla hover:bg-gray-50 hover:text-orange-500 text-center">Editar</Link>
