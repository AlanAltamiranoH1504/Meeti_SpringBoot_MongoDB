            ...
            <header className="bg-gray-50 py-5 border shadow-md">
                <div className="max-w-7xl mx-auto flex flex-col md:flex-row items-center md:justify-between">
                    ...
                    <div className="w-full py-5 lg:p-0 md:w-1/4 space-x-6">
                        ...
                        <Link to="administracion/editar/perfil" className="border-b-4 border-red-600 text-xl font-semibold text-red-600 hover:bg-gray-800 hover:text-white hover:border-none hover:p-1 hover:rounded-md">Mi Perfil</Link>
                        <a onClick={() => {
