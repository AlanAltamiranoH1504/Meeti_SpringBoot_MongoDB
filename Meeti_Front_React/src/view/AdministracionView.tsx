        ...
        <Fragment>
            <div className="max-w-7xl mx-auto md:flex flex-row">
                <div className="md:w-2/5 justify-center align-middle items-center">
                    <h2 className="text-3xl text-center font-fjalla hover:text-red-600">Bienvenido de vuelta <span className="block hover:text-indigo-600">{usuarioEnCache.nombre}</span></h2>
                </div>
